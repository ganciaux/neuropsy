...
var docDefinition = {
  content: [
...

    {
      ...
      table: {
        ...
        body: [
          ...
          [
            {
              text: 'aaaa fixed-width cells have exactly the specified width fixed width cells have exactly the specified width fixed-width cells have exactly the specified width fixed-width cells have exactly the specified width fixed-width cells have exactly the specified width',
              margin: [5, 5, 5, 5],
            },
            {
              text: '',
    ...
    {
      text: 'For better customization, add an image and attach a file to it with linkToFile:',
      pageBreak: 'before',
    },
    {
      columns: [
        {
          image: __dirname + '/../images/logo.jpg',
          fit: [100, 100],
        },
        [
          {
